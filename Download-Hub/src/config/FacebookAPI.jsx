...
async function FacebookMediaDownloader(url) {
    const options = {
        method: 'GET',
    ...
    try {
        // If we find a video we send it back to the facebook.jsx file to render the video
...
export default FacebookMediaDownloader;