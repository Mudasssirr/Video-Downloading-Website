...
async function TikTokMediaDownloader(url) {
    const options = {
        method: 'GET',
    ...
    try {
        // If we find a video we send it back to the tiktok.jsx file to render the video
...
export default TikTokMediaDownloader;